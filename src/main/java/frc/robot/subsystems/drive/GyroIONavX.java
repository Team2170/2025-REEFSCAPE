...
public class GyroIONavX implements GyroIO {
  ...
  public GyroIONavX() {
    ...
    pitchPositionQueue = PhoenixOdometryThread.getInstance().registerSignal(navX::getPitch);
    rollPositionQueue = PhoenixOdometryThread.getInstance().registerSignal(navX::getRoll);
  }
