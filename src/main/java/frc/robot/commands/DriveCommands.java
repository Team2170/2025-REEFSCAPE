...
public class DriveCommands {
    ...
    public static Command JoystickDrive(
        ...
        double xAdjSupplier = xSupplier.getAsDouble() * translationModifier.getAsDouble();
        double yAdjSupplier = ySupplier.getAsDouble() * translationModifier.getAsDouble();
        double omegaAdjSupplier = omegaSupplier.getAsDouble() * rotationModifier.getAsDouble();
        return JoystickDrive(drive, () -> xAdjSupplier, () -> yAdjSupplier, () -> omegaAdjSupplier, robotCentric);
    }
    ...
    public static Command DriveToReefFace(
        ...
        return Commands.run(
                () -> {
                    ...
                    // Calculate angular speed
                    double omega = angleController.calculate(drive.getRotation().getRadians(), face.getRadians());
