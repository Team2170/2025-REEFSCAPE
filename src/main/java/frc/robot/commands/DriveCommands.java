...
public class DriveCommands {
        ...
        /**
         * Field relative drive command using two joysticks Modified (controlling linear
        ...
        public static Command JoystickDrive(
                ...
                double xAdjSupplier = xSupplier.getAsDouble() * (1 - translationModifier.getAsDouble());
                double yAdjSupplier = ySupplier.getAsDouble() * (1 - translationModifier.getAsDouble());
                double omegaAdjSupplier = omegaSupplier.getAsDouble() * (1 - rotationModifier.getAsDouble());
                return JoystickDrive(drive, () -> xAdjSupplier, () -> yAdjSupplier, () -> omegaAdjSupplier,
                                robotCentric);
        }
                ...
                return Commands.run(
                                () -> {
                                        ...
                                        if (distToTag != 0) {
                                                ...
                                                Logger.recordOutput("SingleTagAlign/filteredDistance",
                                                                filteredDistance);
                                        }
                                        if (horizontalDistance != 0) {
                                                filteredHorizontal = yFilter.calculate(horizontalDistance);
                                                Logger.recordOutput("SingleTagAlign/filteredHorizontal",
                                                                filteredHorizontal);
                                        }
                                        if (omega != 0) {
                                        ...
                                        double omegaOutput = filteredOmega == 0 ? 0
                                                        : angleController.calculate(filteredOmega, 0);
        ...
        public static Command alignToTag(
                ...
                return Commands.run(
                                () -> {
                                        ...
                                        double distanceOutput = distanceToTag.getAsDouble() == 0 ? 0
                                                        : xController.calculate(distToTag, 2);
        ...
        public static Command driveToReef(
                ...
                return Commands.run(
                                () -> {
                                        ...
                                        double adjustX = ALIGN_DISTANCE.baseUnitMagnitude()
                                        ...
                                        Logger.recordOutput("driveToReef/omegaError",
                                        ...
                                        // Convert to field relative speeds & send command
                                        ChassisSpeeds speeds = new ChassisSpeeds(
                                                        (linearVelocity.getX() + xOutput)
                                                                        * drive.getMaxLinearSpeedMetersPerSec(),
                                                        (linearVelocity.getY() + yOutput)
                                                                        * drive.getMaxLinearSpeedMetersPerSec(),
                                                        (omegaOutput + omegaOverride)
